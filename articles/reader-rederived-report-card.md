---
title: "公開した数字は片側だった——読者が公開リポから数え直し、2 日で 3 回訂正した。公開 5 面 → 訂正対象 4 面 → 翌朝そろっていたのは 2 面"
emoji: "🪞"
type: "tech"
...
- **「正本」の札**。索引は ARTICLE.md を「正本記事」と書き、運用は Qiita を起点に直していました。**正本の札が一意でなかった**のです。ファイルに正本と書いても、更新の手順に組み込まれていなければ古くなります。7 月から 2 か月、誰も気づきませんでした
...
- 面の一覧と、数字を持つ面を先に書き出す
- 同期の向き（正本 → 写し）を決め、「正本」の札を 1 か所にだけ付ける
- 訂正のたびに全面を点検する表を持つ
